(function () {
  ...
  serverClient = buildServerClient().listen(port);
    ...
    describe('reconnecting', function () {
      it('should attempt to reconnect once server is down', function (done) {
        ...
        var fork   = require('child_process').fork,
          server = fork(__dirname + '/helpers/server_process.js'),
      ...
      it('should reconnect to multiple host-ports combination if servers is passed', function (done) {
        ...
        //var fork   = require('child_process').fork;
        var server2 = buildServerClient().listen(port + 42);
        ...
        server2.on('listening', function () {
          ...
          serverClient.once('client', function (client) {
            client.disconnect();
            done();
          });
